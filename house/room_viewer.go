...
func (rv *roomViewer) makeMat() {
	rv.mat, rv.imat, rv.left_wall_mat, rv.left_wall_imat, rv.right_wall_mat, rv.right_wall_imat = perspective.MakeRoomMats(&rv.room.Size, rv.Render_region, rv.fx, rv.fy, rv.angle, rv.zoom)
}
